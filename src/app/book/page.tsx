    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
        ...
        {step === 2 && selectedProvider && (
          <motion.div key="step2" variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={stepTransition} className="max-w-2xl mx-auto">
            ...
            <SlotPicker
              ...
              // Already answered on its own stage in the referral flow, so the
              // picker opens straight on the calendar rather than asking again.
        ...
        {step === 7 && selectedProvider && (
          <motion.div key="step7" variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={stepTransition} className="max-w-2xl mx-auto">
            <button onClick={() => setStep(0)} className="text-sm text-primary mb-4 flex items-center gap-1">
              <ArrowRight className="h-3.5 w-3.5" /> חזרה לבחירה
            </button>
            <SlotPicker
