      ...
      {({ provider, update }) => {
        ...
        return (
          <div className="flex flex-col gap-6">
            {/* No "how many branches do you have?" declaration — a provider
                states their spread by adding the branches themselves, and a
                count that disagreed with the list below only ever raised a
