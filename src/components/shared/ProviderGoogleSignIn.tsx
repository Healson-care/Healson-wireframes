...
export function ProviderGoogleSignIn({ label = "המשך עם Google" }: { label?: string }) {
  ...
  // Opening the account carries no consent of its own — the privacy gate lives
  // in the application form, right before the phone verification, and applies
  // to the Google path exactly as it does to the email one.
