...
// Not in B_INSURANCE_COMPANIES on purpose — demonstrates the "אחר" free-text
// company flow in InsuranceProfileForm right away when opening /client/profile.
SEED_PATIENTS[0].b_insurance_company = "ביטוח ישיר";
